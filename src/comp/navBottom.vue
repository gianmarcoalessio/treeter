...
<div class="lg:w-full relative">
            <button @click="dropdown = !dropdown" class="flex items-center w-full mt-3 hover:bg-lightgreen rounded-full p-2 focus:outline-none">
                <i class="fas fa-user w-8 h-8 pt-2 rounded-full border border-lighter"></i>
